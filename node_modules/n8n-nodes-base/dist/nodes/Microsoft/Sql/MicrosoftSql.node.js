    ...
    async execute() {
        ...
        try {
            if (operation === 'executeQuery') {
                ...
                await (0, GenericFunctions_1.executeQueryQueue)(tables, ({ table, columnString, items, }) => {
                    return (0, utilities_1.chunk)(items, 1000).map(async (insertValues) => {
                        const values = insertValues.map((item) => (0, GenericFunctions_1.extractValues)(item)).join(',');
                        return pool
                            .request()
