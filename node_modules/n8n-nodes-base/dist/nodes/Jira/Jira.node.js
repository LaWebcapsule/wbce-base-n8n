        ...
        this.methods = {
            listSearch: {
                ...
                async getUsers(filter) {
                    ...
                    const users = await GenericFunctions_1.jiraSoftwareCloudApiRequest.call(this, endpoint, 'GET', {}, query);
                    const returnData = users.reduce((activeUsers, user) => {
                        var _a;
                        if (user.active) {
                            activeUsers.push({
