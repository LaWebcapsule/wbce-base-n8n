...
let Telemetry = exports.Telemetry = class Telemetry {
    ...
    async pulse() {
        ...
        this.executionCountsBuffer = {};
        const sourceControlPreferences = typedi_1.default.get(sourceControlPreferences_service_ee_1.SourceControlPreferencesService).getPreferences();
        const pulsePacket = {
            ...
            source_control_set_up: typedi_1.default.get(sourceControlPreferences_service_ee_1.SourceControlPreferencesService).isSourceControlSetup(),
...
exports.Telemetry = Telemetry = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [posthog_1.PostHogClient,
        License_1.License])
], Telemetry);
