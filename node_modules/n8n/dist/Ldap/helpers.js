...
const getLdapUserRole = async () => {
    return typedi_1.Container.get(role_service_1.RoleService).findGlobalMemberRole();
};
...
const handleLdapInit = async () => {
    ...
    try {
        ...
        n8n_workflow_1.LoggerProxy.warn(`Cannot set LDAP login enabled state when an authentication method other than email or ldap is active (current: ${(0, ssoHelpers_1.getCurrentAuthenticationMethod)()})`, error);
    }
