...
let AuthController = exports.AuthController = class AuthController {
    constructor({ config, logger, internalHooks, postHog, }) {
        this.config = config;
        this.logger = logger;
    ...
    async login(req, res) {
        ...
        if ((0, ssoHelpers_1.isSamlCurrentAuthenticationMethod)()) {
            ...
            if (((_a = preliminaryUser === null || preliminaryUser === void 0 ? void 0 : preliminaryUser.globalRole) === null || _a === void 0 ? void 0 : _a.name) === 'owner' ||
                ((_b = preliminaryUser === null || preliminaryUser === void 0 ? void 0 : preliminaryUser.settings) === null || _b === void 0 ? void 0 : _b.allowSSOManualLogin)) {
                user = preliminaryUser;
                usedAuthenticationMethod = 'email';
            }
            else {
                throw new ResponseHelper_1.AuthError('SSO is enabled, please log in with SSO');
            }
        }
        ...
        if (user) {
            ...
            void typedi_1.Container.get(InternalHooks_1.InternalHooks).onUserLoginSuccess({
                user,
                authenticationMethod: usedAuthenticationMethod,
            });
            return (0, UserManagementHelper_1.withFeatureFlags)(this.postHog, (0, UserManagementHelper_1.sanitizeUser)(user));
        }
        void typedi_1.Container.get(InternalHooks_1.InternalHooks).onUserLoginFailed({
            user: email,
            authenticationMethod: usedAuthenticationMethod,
    ...
    async resolveSignupToken(req) {
        ...
        const users = await this.userService.findMany({ where: { id: (0, typeorm_1.In)([inviterId, inviteeId]) } });
        if (users.length !== 2) {
