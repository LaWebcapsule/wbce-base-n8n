...
let TranslationController = exports.TranslationController = class TranslationController {
    constructor(config, credentialTypes) {
        this.config = config;
    ...
    async getCredentialTranslation(req) {
        ...
        if (!this.credentialTypes.recognizes(credentialType))
            throw new ResponseHelper_1.BadRequestError(`Invalid Credential type: "${credentialType}"`);
    ...
    async getNodeTranslationHeaders() {
        ...
        try {
            ...
            throw new ResponseHelper_1.InternalServerError('Failed to load headers file');
        }
    }
};
__decorate([
