...
import type { BannerName, IConnections, ICredentialDataDecryptedObject, ICredentialNodeAccess, INode, INodeCredentialTestRequest, IPinData, IRunData, IUser, IWorkflowSettings } from 'n8n-workflow';
...
export type AuthlessRequest<RouteParams = {}, ResponseBody = {}, RequestBody = {}, RequestQuery = {}> = express.Request<RouteParams, ResponseBody, RequestBody, RequestQuery>;
export type AuthenticatedRequest<RouteParams = {}, ResponseBody = {}, RequestBody = {}, RequestQuery = {}> = Omit<express.Request<RouteParams, ResponseBody, RequestBody, RequestQuery>, 'user'> & {
    user: User;
...
export declare namespace CurlHelper {
    type ToJson = AuthenticatedRequest<{}, {}, {
        curlCommand?: string;
    }>;
}
