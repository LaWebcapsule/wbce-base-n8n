...
import type { ExecutionError, ICredentialDataDecryptedObject, ICredentialsDecrypted, ICredentialsEncrypted, IDataObject, IDeferredPromise, IExecuteResponsePromiseData, IPinData, IRun, IRunData, IRunExecutionData, ITaskData, ITelemetryTrackProperties, IWorkflowBase, CredentialLoadingDetails, Workflow, WorkflowActivateMode, WorkflowExecuteMode, ExecutionStatus, IExecutionsSummary, FeatureFlags, IUserSettings, IHttpRequestMethods } from 'n8n-workflow';
...
export interface IInternalHooksClass {
    ...
    onServerStarted(diagnosticInfo: IDiagnosticInfo, firstWorkflowCreatedAt?: Date): Promise<unknown[]>;
    ...
    onApiKeyCreated(apiKeyDeletedData: {
        user: User;
        public_api: boolean;
    }): Promise<void>;
...
export type WhereClause = Record<string, {
    [key: string]: string | FindOperator<unknown>;
}>;
