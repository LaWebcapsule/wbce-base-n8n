...
let ActiveWebhooks = exports.ActiveWebhooks = class ActiveWebhooks {
    constructor() {
    ...
    async add(workflow, webhookData, mode, activation) {
        ...
        try {
            await workflow.createWebhookIfNotExists(webhookData, NodeExecuteFunctions, mode, activation, this.testWebhooks);
        }
        catch (error) {
    ...
    async removeWorkflow(workflow) {
        ...
        for (const webhookData of webhooks) {
            await workflow.deleteWebhook(webhookData, NodeExecuteFunctions, mode, 'update', this.testWebhooks);
