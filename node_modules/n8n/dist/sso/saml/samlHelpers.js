...
async function createUserFromSamlAttributes(attributes) {
    ...
    const lowerCasedEmail = (_b = (_a = attributes.email) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '';
    user.email = lowerCasedEmail;
    user.firstName = attributes.firstName;
    user.lastName = attributes.lastName;
    user.globalRole = await typedi_1.Container.get(role_service_1.RoleService).findGlobalMemberRole();
