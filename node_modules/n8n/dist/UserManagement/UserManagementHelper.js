...
function isSharingEnabled() {
    return typedi_1.Container.get(License_1.License).isSharingEnabled();
}
exports.isSharingEnabled = isSharingEnabled;
async function getInstanceOwner() {
    const globalOwnerRole = await typedi_1.Container.get(role_service_1.RoleService).findGlobalOwnerRole();
