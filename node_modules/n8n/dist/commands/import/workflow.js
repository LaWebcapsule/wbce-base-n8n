...
class ImportWorkflowsCommand extends BaseCommand_1.BaseCommand {
    async init() {
        ...
        await super.init();
        this.tagService = typedi_1.Container.get(tag_service_1.TagService);
    }
    async run() {
    ...
    async getOwner() {
        const ownerGlobalRole = await typedi_1.Container.get(role_service_1.RoleService).findGlobalOwnerRole();
