...
class Worker extends BaseCommand_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.uniqueInstanceId = (0, generators_1.generateHostInstanceId)('worker');
    }
    async stopProcess() {
    ...
    async runJob(job, nodeTypes) {
        ...
        additionalData.hooks = WorkflowExecuteAdditionalData.getWorkflowHooksWorkerExecuter(fullExecutionData.mode, job.data.executionId, fullExecutionData.workflowData, { retryOf: fullExecutionData.retryOf });
        try {
