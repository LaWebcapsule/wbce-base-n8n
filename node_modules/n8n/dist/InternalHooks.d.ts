...
export declare class InternalHooks implements IInternalHooksClass {
    ...
    private instanceId;
    get telemetryInstanceId(): string;
    get telemetryInstance(): Telemetry;
    constructor(telemetry: Telemetry, nodeTypes: NodeTypes, roleService: RoleService, executionRepository: ExecutionRepository, eventsService: EventsService);
    ...
    onWorkflowCrashed(executionId: string, executionMode: WorkflowExecuteMode, workflowData?: IWorkflowBase, executionMetadata?: ExecutionMetadata[]): Promise<void>;
