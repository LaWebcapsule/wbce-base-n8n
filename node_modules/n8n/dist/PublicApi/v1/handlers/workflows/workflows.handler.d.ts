...
declare const _default: {
    ...
    getWorkflows: (((req: import("../../../types").AuthenticatedRequest, res: express.Response<any, Record<string, any>>, next: express.NextFunction) => void | express.Response<any, Record<string, any>>) | ((req: WorkflowRequest.GetAll, res: express.Response) => Promise<express.Response>))[];
