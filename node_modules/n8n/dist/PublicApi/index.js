...
exports.isApiEnabled = exports.loadPublicApiVersions = void 0;
...
function isApiEnabledByLicense() {
    const license = typedi_1.Container.get(License_1.License);
    return !license.isAPIDisabled();
}
function isApiEnabled() {
    return !config_1.default.get('publicApi.disabled') && isApiEnabledByLicense();
}
