...
if (constants_1.inE2ETests) {
    const testsDir = (0, path_1.join)((0, os_1.tmpdir)(), 'n8n-e2e/');
    (0, fs_1.mkdirSync)(testsDir, { recursive: true });
    process.env = {
        E2E_TESTS: 'true',
        N8N_USER_FOLDER: (0, fs_1.mkdtempSync)(testsDir),
    ...
    const testsDir = (0, path_1.join)((0, os_1.tmpdir)(), 'n8n-tests/');
    (0, fs_1.mkdirSync)(testsDir, { recursive: true });
    process.env.N8N_LOG_LEVEL = 'silent';
    process.env.N8N_ENCRYPTION_KEY = 'test-encryption-key';
    process.env.N8N_PUBLIC_API_DISABLED = 'true';
    process.env.N8N_USER_FOLDER = (0, fs_1.mkdtempSync)(testsDir);
