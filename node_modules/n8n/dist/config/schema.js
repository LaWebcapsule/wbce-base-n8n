...
convict_1.default.addFormat({
    ...
    coerce(rawValue) {
        return (0, n8n_workflow_1.jsonParse)(rawValue, { errorMessage: 'nodes-list needs to be valid JSON' });
    },
});
exports.schema = {
    database: {
    ...
    logs: {
        ...
        file: {
            ...
            location: {
                ...
                format: String,
                default: path_1.default.join(n8n_core_1.UserSettings.getUserN8nFolderPath(), 'logs/n8n.log'),
    ...
    binaryDataManager: {
        ...
        localStoragePath: {
            format: String,
            default: path_1.default.join(n8n_core_1.UserSettings.getUserN8nFolderPath(), 'binaryData'),
